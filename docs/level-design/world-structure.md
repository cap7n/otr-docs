...
- **Zone themes are anachronistic, even time is not certain.** Each cube is a **sample**: a 2x2 km slice of a different time period, region, or civilization, extracted whole - think *Cube*, scaled way up. The garage sits in a 1990s American gas station. The next zone over might be a cyberpunk factory complex, or an abandoned 21st-century city. The dissonance is the world's texture, any art direction has a home, and car upgrades can span eras (junkyard parts to futuristic tech).
- **Why it was built is unknown in-world.** Theories the inhabitants left behind: a sampling project, a conservation effort, a sick museum. Even the smartest survivors never knew. (The **sampling project** theory is now the designers' answer key - the structure is a *Prospector* mining arrangement; see [World & Story](world-story.md) - though it stays unknowable to everyone inside.) The megastructure connecting the cubes used to *function* - some automated systems still tick along with nobody left to maintain them.
