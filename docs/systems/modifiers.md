...
| **Aggro** | 2x detection range, more frequent attacks | +35% |
...
| **Glass Cannon** | Turret damage x2, car damage taken x1.5 |
| **Scavenger** | No shop this run, loot drops x3 |
| **Bomber Run** | Start with 5 bombs; enemies drop bombs instead of loot |
| **Heavyweight** | Car mass x2, tankier, slower, devastating rams |
...
| **Big Head Mode** | Enemy meshes x2, easier to hit, looks ridiculous |
| **Turbo Fuse** | All explosions x3 radius (theirs AND yours) |
...
- **Conflicts** declared per modifier (e.g. Speed Demon x No Brakes), selecting one greys out the other.
